...
-- Tabla: ACTActivoSeguro
CREATE TABLE ACTActivoSeguro (
    idRegistro SERIAL NOT NULL,
    iIdActivo INTEGER,
    idEmpresa INTEGER,
    dFechaInicioS TIMESTAMP,
    dFechaFinS TIMESTAMP,
    dValorSeguro NUMERIC(18, 2)
);
...
-- Tabla: tblFacturaFacturador
CREATE TABLE tblFacturaFacturador (
    iIdFactura INTEGER,
    vCIRuc VARCHAR(13)
);
...
-- Tabla: SEGtblUsuarioOpciones
CREATE TABLE SEGtblUsuarioOpciones (
    vUsuario VARCHAR(30) NOT NULL,
...
-- Tabla: ODONtblTratamientoDetalleProducto
CREATE TABLE ODONtblTratamientoDetalleProducto (
    iIdEspecialidad INTEGER NOT NULL,
    siTratamiento SMALLINT NOT NULL,
    iIdTratamientoDetalle INTEGER NOT NULL,
    iIdProducto INTEGER NOT NULL,
    dCantidad NUMERIC(5, 2),
    CONSTRAINT PK_tblTratamientoDetalleProducto PRIMARY KEY (iIdEspecialidad, siTratamiento, iIdTratamientoDetalle, iIdProducto)
);
...
-- Tabla: ODONtblDoctorEspecialidad
CREATE TABLE ODONtblDoctorEspecialidad (
    iIdDoctor INTEGER NOT NULL,
    iIdEspecialidad INTEGER NOT NULL,
    CONSTRAINT PK_ODONtblDoctorEspecialidad PRIMARY KEY (iIdDoctor, iIdEspecialidad)
);
...
-- Tabla: ODOntblCotizacionDetalle
CREATE TABLE ODOntblCotizacionDetalle (
    iIdDetalle SERIAL NOT NULL,
    ...
    iIdTratamientoDetalle INTEGER,
    dValor NUMERIC(9, 2),
    dValorFinal NUMERIC(9, 2),
    cEstado CHAR(1)
);

-- Tabla: ODOntblCotizacion
CREATE TABLE ODOntblCotizacion (
    iIdCotizacion SERIAL NOT NULL,
    iIdPaciente INTEGER,
    dFechaCotizacion TIMESTAMP,
    vUsuario VARCHAR(20),
    vUsuarioAut VARCHAR(20)
);
...
-- Tabla: ODONtblCitaMedica
CREATE TABLE ODONtblCitaMedica (
    iIdPaciente INTEGER NOT NULL,
    iIdDoctor INTEGER NOT NULL,
    iIdConsultorio INTEGER,
    iIdEspecialidad INTEGER NOT NULL,
    dFechaCita TIMESTAMP NOT NULL,
    cHoraCita CHAR(5) NOT NULL,
    iTiempo SMALLINT NOT NULL,
    cEstado CHAR(1) NOT NULL,
    vUsuarioIng VARCHAR(30),
    CONSTRAINT PK_ODONtblCitaMedica PRIMARY KEY (iIdPaciente, iIdDoctor, iIdEspecialidad, dFechaCita, cHoraCita)
);
...
-- Tabla: BaseTabla
CREATE TABLE BaseTabla (
    BaseDato CHAR(50) NOT NULL,
    Tabla VARCHAR(150) NOT NULL,
    DescripcionAplicacion CHAR(100) NOT NULL,
    CONSTRAINT PK_BaseTabla PRIMARY KEY (BaseDato, Tabla)
);
...
CREATE TABLE Base (
    BaseDato CHAR(50) NOT NULL,
    DescripcionAplicacion CHAR(100) NOT NULL,
    CONSTRAINT PK_Base PRIMARY KEY (BaseDato)
);
...
-- Tabla: INVTBLTiposMovimiento
CREATE TABLE INVTBLTiposMovimiento (
    iIdTipoMov SERIAL NOT NULL,
    vShortname VARCHAR(5) NOT NULL,
    vMovimiento VARCHAR(40) NOT NULL,
    vAplicacion VARCHAR(3),
    vIE VARCHAR(1) NOT NULL,
    iTransferencia SMALLINT NOT NULL,
    iCosteo SMALLINT NOT NULL,
    IdTipoMovTrans INTEGER NOT NULL,
    bIngresaCostos BOOLEAN NOT NULL,
    bPermiteModificar BOOLEAN NOT NULL
);
